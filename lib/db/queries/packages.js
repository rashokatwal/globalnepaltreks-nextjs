...
export const PackageQueries = {
    ...
    // =====================================================
    // NEW METHODS FOR HOMEPAGE SECTIONS
    // =====================================================
    
    // Get best selling packages (manually flagged)
    ...
    // Get luxury packages (manually flagged)
    ...
    // Get adventure packages (manually flagged)
