// app/components/NotFoundClient.tsx
"use client";
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12 flex flex-col items-center justify-center min-h-[calc(100vh-80px)]">
        ...
        <div className="relative mb-6 md:mb-8 text-center">
          <div className="flex flex-col items-center mt-20 justify-center">
            <div className="relative w-56 md:w-72 lg:w-96 h-36 md:h-44 mb-3">
              ...
              >
                <polygon points="50,200 150,50 250,200" className="fill-gray-400 dark:fill-gray-600" />
                <polygon points="150,200 250,30 350,200" className="fill-gray-500 dark:fill-gray-500" />
                <polygon points="250,200 330,80 380,200" className="fill-gray-600 dark:fill-gray-400" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 md:p-5 mb-6 max-w-md transform hover:scale-105 transition-transform duration-300 mx-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs text-primary-color-dark font-semibold mb-1">Trekker's Trivia</p>
              <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">{currentFact}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-4 max-w-2xl w-full mb-8 px-4">
          <Link href="/" className="group bg-white dark:bg-gray-800 rounded-lg p-3 md:p-4 text-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <FontAwesomeIcon icon={faArrowLeft} className="text-xl md:text-2xl text-primary-color-dark mb-1 md:mb-2" />
            <h3 className="font-semibold text-xs md:text-sm text-gray-800 dark:text-white">Base Camp</h3>
          </Link>

          <Link href="/destinations" className="group bg-white dark:bg-gray-800 rounded-lg p-3 md:p-4 text-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <FontAwesomeIcon icon={faMapMarkedAlt} className="text-xl md:text-2xl text-primary-color-dark mb-1 md:mb-2" />
            <h3 className="font-semibold text-xs md:text-sm text-gray-800 dark:text-white">Destinations</h3>
          </Link>

          <Link href="/contact" className="group bg-white dark:bg-gray-800 rounded-lg p-3 md:p-4 text-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <FontAwesomeIcon icon={faCompass} className="text-xl md:text-2xl text-primary-color-dark mb-1 md:mb-2" />
        ...
        <div className="w-full max-w-md px-4">
          <div className="relative">
            ...
            />
            <button className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-primary-color-dark text-white p-2 rounded-full h-10 w-10">
